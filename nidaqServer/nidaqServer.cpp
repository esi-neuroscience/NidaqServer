...
// nidaqServer.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CnidaqServerApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CnidaqServerApp::OnAppAbout)
...
// The one and only CnidaqServerApp object

CnidaqServerApp theApp;


// CnidaqServerApp initialization

BOOL CnidaqServerApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CnidaqServerDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CnidaqServerView));
	if (!pDocTemplate)
		return FALSE;
...
// CnidaqServerApp message handlers
...
void CnidaqServerApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
